...
export const PROGRESS_UPDATED_EVENT = 'oop-progress-updated';
...
function dispatchProgressUpdated(state) {
  if (!isBrowser()) return;
...
export function resetProgress() {
  if (isBrowser()) {
    ...
    dispatchProgressUpdated(getDefaultState());
  }
  return getDefaultState();
}
